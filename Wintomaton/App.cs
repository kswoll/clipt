...
namespace Wintomaton
{
    public class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            AppIcon.BeginInit();
            AppIcon.UriSource = new Uri("pack://application:,,,/Wintomaton;component/Assets/Wintomaton.ico");
            AppIcon.EndInit();
...
new MyScript().Run();
", ScriptOptions.Default.WithImports("Wintomaton", "System.Windows").AddReferences(typeof(Script).Assembly)).RunAsync();
*/
